...
const basis: &'static [&'static str] = &[
    "1", "e1", "e2", "e3", "e4", "e5", "e12", "e13", "e14", "e15", "e23", "e24", "e25", "e34",
    "e35", "e45", "e123", "e124", "e125", "e134", "e135", "e145", "e234", "e235", "e245", "e345",
    "e1234", "e1235", "e1245", "e1345", "e2345", "e12345",
];
...
impl IndexMut<usize> for CGA {
    fn index_mut<'a>(&'a mut self, index: usize) -> &'a mut Self::Output {
        &mut self.mvec[index]
    }
}

impl fmt::Display for CGA {
...
fn basics() {
    ...
    assert_eq!(&px.to_string(), "1e1 + 2e2 + 3e3 + -2.5e4 + 4.5e5");
    assert_eq!(&line.to_string(), "1e145 + 2e245 + 3e345");
    assert_eq!(&sphere.to_string(), "-0.5e1234 + -1.5e1235");
}
